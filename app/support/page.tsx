...
export default function SupportPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (lowerInput.includes("csv") || lowerInput.includes("upload") || lowerInput.includes("file")) {
      ...
      response = "We offer 3 options:\n\n• Starter ($499/scan): Up to 10,000 sq ft, 3D detection + PDF report, 24-hr turnaround\n• Pro ($1,999/mo): Up to 8 scans/month (each up to 10,000 sq ft), priority scheduling, team access for 3 users\n• Enterprise (custom): Custom volume, multi-site workflows, dedicated support\n\nAdd-ons like 3D mapping, data exports, and more are available. Check our Pricing page for details!"
